                    ...
                    <section>
                        ...
                        <form method="post" class="mt-6 space-y-6">
                            ...
                            <div>
                                ...
                                <x-text-input id="name" name="name" type="text" class="mt-1 block w-full"  :value="old('name', $cat->name)" required autofocus autocomplete="name" />
                            ...
                            <div class="flex items-center gap-4">
                                <button id="editCategory" type="button" data-id="{{ $cat->id }}">Save</button>
                            </div>
                        </form>
                    </section>
                </div>
